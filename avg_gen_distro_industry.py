...
def load_live_data():
    ...
    # If the file isn't on the cloud server yet, run the fetcher script
...
# Load the dataset safely into memory
df_historical = load_live_data()

# --- SIDEBAR YEAR FILTERS ---
st.sidebar.header("🗓️ Select Year Range")

# Determine data boundaries dynamically based on what the API pulled
...
if from_year > to_year:
    ...
    # Filter dataset using pandas boolean masking
